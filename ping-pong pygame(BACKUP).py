#There is a secret hack to this game!
import pygame
import sys
import math
class Ball(object):
...
class Pong(object):
    ...
    def __init__(self):
        ...
        pygame.display.set_caption("Don't Let The Ball Touch The Ground!      By Fred=)")
        self.ball = Ball(5, 5, 50, 50, 5, 5, Pong.COLOURS["BLACK"])
        self.paddle = Paddle(WIDTH / 2, HEIGHT - 50, 100,10, 3, Pong.COLOURS["BLACK"])
        self.score = 0
    def play(self):
    ...
    def draw(self):
        ...
        score_text = font.render("Score: " + str(self.score), True,Pong.COLOURS["RED"])
...
if __name__ == "__main__":
    Pong().play()    
#The high score of this game is 356, made by ( ͡ ͜ ͡)
